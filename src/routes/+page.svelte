...
<main class="flex flex-col justify-center m-5 mx-auto justify-self-center md:w-1/2 border p-4">
	...
	<article>
		...
		<p>
			To start lets go over the most common icons, some of these appeared in the pamphlet but lets
			go over them again
		</p>
		...
		<div class="icon_desc">
			<img
				src="/assets/close_windows.png"
				alt="A screenshot of a windows 11 close window button."
			/>
			<p class="ml-2">X: this will close the program</p>
		</div>
		<div class="icon_desc">
			<img
				src="/assets/maximize_windows.png"
				alt="A screenshot of a windows 11 maximize window button."
			/>
			<img
				src="/assets/resize_windows.png"
				alt="A screenshot of a windows 11 resize window button."
			/>
			<p class="ml-2">Square(s): this will make the window full screen or exit full screen</p>
		</div>
		<div class="icon_desc">
			<img
				src="/assets/minimize_windows.png"
				alt="A screenshot of a windows 11 minimize window button."
			/>
			<p class="ml-2">
				Minimize: this will minimize the program, usually sending it down to the bottom bar, this
				gets it out of your way without closing it completely so you can go back to it later.
			</p>
		</div>
		<br />
		<hr />
		...
		<h2>Cursor</h2>
		<p>
			The cursor is the icon that moves around the screen with your mouse or trackpad. It has many
			different icons that each mean something different
		</p>
		<div class="icon_desc">
			<img src="/assets/cursor/default.gif" alt="The default cursor icon." />
			<p class="ml-2">Cursor arrow: this is the default cursor icon</p>
		</div>

		<div class="icon_desc">
			<img src="/assets/cursor/pointer.gif" alt="The pointer cursor icon." />
			<p class="ml-2">
				Pointer: this looks like a little hand pointing its finger and it usually denotes an option
				to select
			</p>
		</div>
		<div class="icon_desc">
			<img src="/assets/cursor/text.gif" alt="The text input cursor icon." />
			<p class="ml-2">Type I: This icon means this space is for typing</p>
		</div>
		<div class="icon_desc">
			<img src="/assets/cursor/grab.gif" alt="The grabber cursor icon." />
			<p class="ml-2">Hand: this allows you to 'grab' by clicking and move things around</p>
		</div>
		<div class="icon_desc">
			<img src="/assets/cursor/resize.gif" alt="The resize cursor icon." />
			<p class="ml-2">
				Resize: arrows going in both directions in any orientation will allow you to resize an
				object like a window or image
			</p>
		</div>
		<div class="icon_desc">
			<!-- TODO -->
			<img src="/assets/cursor/??????" alt="The ????? cursor icon." />
			<p class="ml-2">Arrow cross: this allows you to move things around or scroll on a page</p>
		</div>
		<br />
		<hr />
		<br />
		<h2>Other good to knows</h2>
		<div class="icon_desc">
			<img src="/assets/gear.png" alt="A 'gear' or 'settings' icon." />
			<p>Gear: gear icons are used to denote settings in programs as well as for devices</p>
		</div>
		<div class="icon_desc">
			<img src="/assets/logo.png" alt="The Teaching Tech Lit logo." />
			<p>
				Site logo: by clicking on the logo for a website it will usually take you to the home page
			</p>
		</div>
		<div class="icon_desc">
			<img src="/assets/app.png" alt="A random selection of icons from different apps." />
			<p>App icons: app icons are unique to each app and are used to start the program</p>
		</div>
	</article>
	<article>
