...
<div class="hero">
	<div class="grid lg:grid-cols-2 content-area">
		<div class="flex flex-col justify-center leading-loose justify-items-center px-4 text-white">
			...
			<button class=" bg-transparent mt-4 py-2 px-4 border border-white text-white font-light rounded w-52 text-2xl">
				Get Started
			</button>
			 <!-- <a 
				href="/buttons"
...
<!-- Lessons section -->
	...
	<div class="grid lg:grid-cols-3 mt-10 mb-10">
		<div class="cards rounded overflow-hidden shadow border py-2">
			...
			<div class="py-2">
			  <span class="inline-block px-4 bg-gray-200 rounded-full text-base font-semibold text-gray-700">Not Completed</span>
			</div>
			<button class="p-2 border card-btn text-2xl text-white rounded hover:bg-blue-600 hover:border-blue-600">Start</button>
		  </div>
		  <div class="cards rounded overflow-hidden shadow border py-2">
			<div class="">
			  <div class="font-bold text-3xl py-4 mb-2 text-gray-800">Browsers</div>
